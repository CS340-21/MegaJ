...
We did learn a lot when it came to IOS application development, using swift, and how to design the user interface. We were able to accomplish a lot of our goals pertaining to inputting recipes and sorting by number of ingredients in the pantry. It was more difficult to implement many of our ideas than we expected, which caused delays in development. Overall, we are happy with the prototype and believe that with further improvements the application could potentially be a real competitor. 
...
<img src="Images/IngredientBefore.png" width=300><img src="Images/IngredientInput.png" width=300><img src="Images/IngredientAfter.png" width=300>
